        ...
        <div className="hidden items-center gap-3 md:flex">
          {user ? (
            ...
            <>
              ...
              <Link
                to="/login"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-cta-500 px-5 py-3 text-sm font-bold text-white transition-all hover:-translate-y-0.5 hover:bg-cta-600 hover:shadow-[0_10px_24px_rgba(20,184,152,0.35)]"
              >
                {t('common.signup')}
              </Link>
            </>
