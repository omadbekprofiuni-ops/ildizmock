      ...
      <section className="relative overflow-hidden px-8 pb-20 pt-24">
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          <div className="eyebrow">
            ...
            Trusted by 1,200+ Uzbek students preparing for Band 7+
          </div>
          <h1 className="mt-7 text-5xl font-extrabold leading-[1.05] tracking-tight text-slate-900 md:text-6xl lg:text-[66px]">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-3.5">
            ...
            <Link
              to="/pricing"
              className="inline-flex items-center justify-center gap-2 rounded-2xl border-2 border-slate-200 px-7 py-4 text-base font-bold text-slate-700 transition-all hover:border-brand-300 hover:bg-brand-50 hover:text-brand-700"
            >
              {t('nav.pricing')}
            </Link>
          </div>
          ...
          {/* Trust signals */}
          <div className="mt-14 flex flex-wrap items-center justify-center gap-x-10 gap-y-3 text-sm text-slate-500">
            {TRUST.map((label) => (
