...
urlpatterns = [
    ...
    path(
        'mock/audio-played/<str:browser_session_id>/',
        student_views.mark_audio_played,
        name='mock-mark-audio-played',
    ),
    path(
        'mock/audio-finished/<str:browser_session_id>/',
        student_views.mark_audio_finished,
